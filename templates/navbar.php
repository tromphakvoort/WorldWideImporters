<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container">
        <a class="navbar-brand" href="<?php echo $routes->get('homepage')->getPath() ?>">
            <img src="<?php echo URL_SUBFOLDER . "/assets/logo.png" ?> " alt="World Wide Importers" width="60">
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item" target="_self" href="<?php echo $routes->get('category1')->getPath() ?>">Melkchocolade</a></li>
                        <li><a class="dropdown-item" target="_self" href="<?php echo $routes->get('category2')->getPath() ?>">Pure chocolade</a></li>
                        <li><a class="dropdown-item" target="_self" href="<?php echo $routes->get('category3')->getPath() ?>">Witte chocolade</a></li>
                    </ul>
                </li>
                <li class="nav-item">
            ...
            <ul class="navbar-nav justify-content-end">
                <li class="nav-item">
                <a href="<?php echo $routes->get('cart')->getPath() ?>"
