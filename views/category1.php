...
<div class="album py-5 bg-light">
    <div class="container">
        ...
        <div class="row">
            ...
            $results = mysqli_query($connection, "SELECT p.id, product_name, description, file_location, filename, mimetype FROM products p JOIN productcategories pc ON p.id=fk_prodcat_product_id JOIN attachments a ON fk_att_product_id=p.id WHERE fk_prodcat_cat_id=1");
