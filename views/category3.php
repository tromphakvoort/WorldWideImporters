<?php $title = "Witte chocolade | World Wide Importers";
include("../templates/header.php");?>
<body>
<div class="album py-5 bg-light">
    <div class="container">
        <h1>Witte chocolade</h1>
        <div class="row">
                <?php
                //mySQLi information
                $db_host = "10.10.1.3";
                ...
                // Query for category 3
                $results = mysqli_query($connection, "SELECT p.id, product_name, description, file_location, filename, mimetype FROM products p JOIN productcategories pc ON p.id=fk_prodcat_product_id JOIN attachments a ON fk_att_product_id=p.id WHERE fk_prodcat_cat_id=3");
